...
#include "AI/Decorators/AIS_BTDec_IsReadyToAttack.h"
...
bool UAIS_BTDec_IsReadyToAttack::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
